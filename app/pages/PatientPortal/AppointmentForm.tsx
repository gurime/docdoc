            ...
            try {
                ...
                if (user) {
                    ...
                    const { data: doctorData, error: doctorError } = await supabase
                        ...
                        .eq('id', userData.doctor_id); // Only fetch the assigned doctor
                ...
                .insert([
                    {
                        ...
                        zip_code: zipCode,
                        appointment_date: appointmentDate.toISOString().split('T')[0], // Use toISOString() here
                        appointment_time: selectedTime, // Use selectedTime here
                        doctor_id: doctorId,
                        doctorname: selectedDoctor.doctorname, // Include doctorname here
                    },
                ]);
            if (appointmentError) throw appointmentError;

            // Update user's assigned doctor (if needed)
